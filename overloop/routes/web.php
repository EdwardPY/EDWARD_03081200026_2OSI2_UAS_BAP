...
Route::get('/admin/discount', 'App\Http\Controllers\discountController@index');
Route::get('/admin/discount/print_pdf', 'App\Http\Controllers\discountController@print_pdf');
Route::resource('admin/voucher', 'App\Http\Controllers\Admin\VoucherController');